 ...
 */
final class Version20220412101801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__book AS SELECT id, author_id, title, isbn, published_at FROM book');
        ...
        $this->addSql('INSERT INTO book (id, author_id, title, isbn, published_at) SELECT id, author_id, title, isbn, published_at FROM __temp__book');
